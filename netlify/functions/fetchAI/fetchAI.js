...
const handler = async (event) => {
  ...
  if (path === '/fetchAI/fetchBotReply') {
    ...
    // Implement performfetchTitle or remove this block if not needed
    ...
    // Implement performfetchBotSynopsis or remove this block if not needed
    ...
    // Implement performfetchStars or remove this block if not needed
    ...
    // Implement performfetchImagePrompt or remove this block if not needed
    ...
    // Implement performfetchImage or remove this block if not needed
